...
levelSizes = [(1500, 800)] #List of the sizes of each level to use to transform each image, and set limits to how far our character can go
backgrounds = []
...
hubPlats = [Rect(130, 700, 100, 10), Rect(530, 700, 100, 10), Rect(330, 550, 100, 10), Rect(130, 400, 100, 10), Rect(530, 400, 100, 10)]
hubBlocks = [Rect(-110, 0, 210, 350), Rect(-110, 450, 210, 350), Rect(1900, 700, 210, 100), Rect(1900, 0, 210, 100)]
